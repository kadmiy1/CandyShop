        ...
        <div class="container">
            ...
            <div class="block rega">
                <form action="php/firmcreate.php" method="post">
                    <h1 title="Добавление фирмы">Добавление фирмы</h1>
                    <div class="group">
                    ...
                    <div class="group">
                        ...
                        <input type="text" required  placeholder="Номер телефона" name="phone" id="phone">
                    </div>
